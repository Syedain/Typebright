			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						<div id="logo">
							<a href="index.html" class="standard-logo" style="height: 50px;"
								data-dark-logo="images/typebrightwhite.png"><img src="images/typebrightblack.png" alt=""></a>
							<a href="index.html" class="retina-logo" data-dark-logo="images/typebrightwhite.png"><img
									src="images/typebrightwhite.png" alt=""></a>
						</div>
						...
						<nav class="primary-menu not-dark with-arrows">
							...
							<ul class="menu-container not-dark">
														...
														<a class="menu-link" href="#">
															<div>
																...
																<div style="margin-bottom: 20px;">
																	<img src="images/Group-1.png.webp" alt="" style="margin-right: 15px;">
																	<img src="images/microsoft-dot-net-icon-1.png.webp" alt=""
																		style="margin-right: 15px;">
																	<img src="images/python-1-1.png.webp" alt="" style="margin-right: 15px;">
																	<img src="images/java-svgrepo-com-1.png.webp" alt="" style="margin-right: 15px;">
																</div>
																<div>
																	<img src="images/Group.png.webp" alt="" style="margin-right: 15px;">
																	<img src="images/vue-1-1.png.webp" alt="" style="margin-right: 15px;">
																	<img src="images/Vector-11.png.webp" alt="" style="margin-right: 15px;">
																	<img src="images/Vector-8-1.png.webp" alt="" style="margin-right: 15px;">
																</div>
															</div>
														</a>
													</li>
											...
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col">
													<li class="menu-item">
														<a class="menu-link" href="#">
															<div>
																<h5>All Industries <i class="icon-line-arrow-right fw-semibold"></i></h5>
																<div style="margin-bottom: 20px;">
																	<img src="images/python-1-1.png.webp" alt="" style="margin-right: 15px;">
																	<img src="images/java-svgrepo-com-1.png.webp" alt="" style="margin-right: 15px;">
																</div>
								...
								<li class="menu-item"><a class="menu-link" href="insights.html">
										<div>Insights</div>
									</a></li>
								<li class="menu-item"><a class="menu-link" href="careers.html">
										<div>Careers</div>
									</a></li>
								<li class="menu-item">
									<a class="menu-link" href="getInTouch.html">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6 mb-0 mb-sm-4 mb-md-0">
							...
							<div class="widget clearfix">
								...
								<h4 style="color: #fff;">About Typebright</h4>
								...
								<div style="background: url('images/world-map.png') no-repeat left center; background-size: auto 100%;">
									...
									<abbr title="Email Address"><strong>Email:</strong></abbr> info@typebright.com
								</div>
					...
					<div class="row justify-content-between col-mb-30">
						...
						<div class="col-12 col-md-auto text-center text-md-end">
							<div class="copyrights-menu copyright-links clearfix">
								<a href="./">Home</a>/<a href="about-me.html">About Us</a>/<a href="#">Team</a>/<a href="#">Clients</a>/<a
